...
export const LiveTraceTicker: React.FC<LiveTraceTickerProps> = ({
  ...
  return (
    <div className="fixed top-28 left-1/2 -translate-x-1/2 z-30 w-full max-w-2xl px-4 pointer-events-auto">
      <div className="bg-[#111116]/95 backdrop-blur-md border border-[#272736] rounded-2xl shadow-2xl overflow-hidden transition-all duration-300">
        {/* Main Status Row */}
