...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-black/90 backdrop-blur-md px-4 py-2 lg:flex border border-zinc-800",
        visible && "bg-black/95",
        className,
      )}
    >
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-black/90 backdrop-blur-md px-0 py-2 lg:hidden border border-zinc-800 rounded-2xl",
        visible && "bg-black/95",
        className,
      )}
    >
